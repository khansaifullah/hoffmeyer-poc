...
export default function ProductListingSection({
  ...
  return (
    <section className="overflow-x-hidden bg-white px-4 py-6 md:px-8 md:py-10">
      <div className="mx-auto max-w-7xl min-w-0">
        <div className="mb-4 flex flex-col gap-2 border-b border-gray-200 pb-3 md:mb-6 md:flex-row md:items-center md:justify-between md:pb-4">
          <p className="text-[13px] font-bold uppercase tracking-wide text-[#111] md:text-[14px]">
            {displayCount.toLocaleString()} Results
          </p>
          <p className="hidden items-center gap-2 text-[12px] text-gray-500 sm:flex">
